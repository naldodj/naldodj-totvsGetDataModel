BEGIN
  ...
  FROM (
     ...
     DISTINCT CTT.CTT_FILIAL 
             ...
             ,CTT.CTT_DESC01 
         FROM CTT990 CTT
         JOIN SRD ON (CTT.CTT_CUSTO=SRD.RD_CC)
        ...
        WHERE CTT.D_E_L_E_T_=''
          ...
          AND SRV.RV_FILIAL=(CASE SRV.RV_FILIAL WHEN ' ' THEN ' ' ELSE LEFT(SRD.RD_FILIAL,LEN(CTT.CTT_FILIAL)) END)
          AND ZY_.ZY__FILIAL=(CASE ZY_.ZY__FILIAL WHEN ' ' THEN ' ' ELSE LEFT(SRD.RD_FILIAL,LEN(CTT.CTT_FILIAL)) END)
 ) t
END