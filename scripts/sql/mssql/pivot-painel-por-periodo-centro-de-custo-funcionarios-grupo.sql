              ...
              FROM (			        
                    ...
                    (SELECT * FROM 
                        (
                         ...
                         GROUP BY SRD.RD_FILIAL,SRD.RD_DATARQ,SRA.RA_MAT,SRA.RA_NOME,RA_ADMISSA,RD_CC,CTT.CTT_DESC01,ZY_.ZY__MASTER,ZY_M.ZY__SQLFLD,ZY_.ZY__SQLFLD
                        ) ROW
                    PIVOT (SUM(ROW.RD_VALOR) FOR ZY__SQLFLD IN (' + @COLUNAS_PIVOT + ')) COL ) t
                    GROUP BY t.RD_FILIAL,t.RD_DATARQ,t.RD_CC,t.CTT_DESC01,t.RA_MAT,t.RA_NOME,t.RA_ADMISSA,t.'+@COLUNAS_PIVOT+') t
