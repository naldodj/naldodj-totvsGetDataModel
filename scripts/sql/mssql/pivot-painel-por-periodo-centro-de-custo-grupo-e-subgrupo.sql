        ...
        SET @COMANDO_SQL = '
             SELECT t.RD_DATARQ
			  ...
			  (			        
                    ...
                    (
                        ...
                        (
                            ...
                            WHERE SRD.D_E_L_E_T_='''' 
                              ...
                              AND ZY_.ZY__MASTER BETWEEN '''+@GRUPODE+''' AND '''+@GRUPOATE+'''
                              AND ZY_.ZY__SQLFLD<>''''
                         GROUP BY SRD.RD_DATARQ,SRD.RD_FILIAL,SRD.RD_CC,CTT.CTT_DESC01,ZY_M.ZY__CODIGO,ZY_M.ZY__SQLFLD,ZY_.ZY__SQLFLD
                        ) ROW
                ...
                GROUP BY t.RD_DATARQ,t.RD_FILIAL,t.RD_CC,t.CTT_DESC01,'+@COLUNAS_PIVOT+'
			 ) t
             GROUP BY t.RD_DATARQ,t.RD_FILIAL,t.RD_CC,CTT_DESC01'
            BEGIN TRANSACTION @TTSNAME
                EXECUTE('SELECT * INTO '+@TABLENAME+' FROM ('+@COMANDO_SQL+') t') 
            COMMIT TRANSACTION @TTSNAME
	END TRY
	BEGIN CATCH
			EXECUTE('SELECT * INTO '+@TABLENAME+' FROM (SELECT '''' RD_DATARQ, '''' RD_FILIAL, '''' RD_CC, '''' CTT_DESC01,0 TOTAL ) t')
	END CATCH;
END