SELECT SRA.RA_FILIAL
    ...
    WHERE SRA.D_E_L_E_T_=''
      ...
      AND SRV.RV_FILIAL=(CASE CTT.CTT_FILIAL WHEN '' THEN '' ELSE LEFT(SRD.RD_FILIAL,LEN(SRV.RV_FILIAL)) END)
      AND SRJ.RJ_FILIAL=(CASE CTT.CTT_FILIAL WHEN '' THEN '' ELSE LEFT(SRA.RA_FILIAL,LEN(SRJ.RJ_FILIAL)) END)
      ...
      AND SRA.RA_MAT BETWEEN !MATRICULADE! AND !MATRICULAATE!
